                        ...
                        <div class="rounded shadow-lg p-4 px-4 w-full">
                            <div class="grid gap-4 gap-y-2 text-sm">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 w-full">
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="email">Correo electrónico para recibir notificaciones</label>
                                        <div class="relative mb-2">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                    ...
                                    <div class="md:col-span-5">
                                        <label for="smtp">Host para enviar mail</label>
                                        <div class="relative mb-3">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="text" id="smtp" name="smtp"
                                                value="{{ $general->smtp }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Ejemplo: smtp.gmail.com / mail.codefinan.com / otros">
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <div class="relative mb-3">
                                            ...
                                            <input type="text" id="emailsend" name="emailsend"
                                                value="{{ $general->emailsend }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="info@codefinan.com">
                                        </div>
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="contrasend">Contraseña</label>
                                        <div class="relative mb-3">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400"
                                            ...
                                            <input type="password" id="contrasend" name="contrasend"
                                                value="{{ $general->contrasend }}"
                                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                             >
                                        </div>
                                    </div>
